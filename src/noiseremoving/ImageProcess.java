    ...
    public void removeNoise()
    {
        ...
        for(int i = 1; i < hight-1; i++)
        {
            for(int j = 1; j < width-1; j++)
            {
                ...
                CollectionSort<Integer> sort = new CollectionSort<>();
                
                sort.setArray(intensity_r); //Set intensity_r array to the CollectionSort Object.
                
                sort.quickSort(); // Call quickSort method for sorting
                intensity_r = sort.getArray(); // Updates intensity_r array with the sorted values.
                
                sort.setArray(intensity_g); 
                sort.quickSort(); 
                intensity_g = sort.getArray(); 
                
                sort.setArray(intensity_b); 
                sort.quickSort(); 
                intensity_b = sort.getArray();
